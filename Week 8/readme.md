...
Assignment completion date: 2026-07-12

Completion tracking rule implemented:
- Daily habits store the selected completed_on date directly.
- Weekly habits store the first day of that week as period_start.
- Monthly habits store the first day of that month as period_start.
